        ...
        <main>
            <section className="quienesSomos">
                <div className="titleQuienesSomosDiv">
                    ...
                    <h1 className={`titleQuienesSomos fw-bold ${incSize ? "fs-2" : "fs-3"}`}>
                        Quienes Somos
                    </h1>
                </div>
                ...
                <article className="container equipoArticle">
                    ...
                    <div>
                        <h5 className={`titleEquipo my-3 fw-bold ${incSize ? "fs-4" : "fs-5"}`}>Dirección General y CEO</h5>
                    ...
                    <div>
                        ...
                        <p className={`parrafoNamesEquipo  ${incSize ? "fs-5" : "fs-6"}`}>Marisol Belén Illanes Quiroga</p>
                    ...
                    <div>
                        <article className="areasGrid row">
                            ...
                            <div className="col-lg-4 col-xs-12">
                                ...
                                <h5 className={`titleEquipo fw-bold ${incSize ? "fs-4" : "fs-5"}`}>Área Intérpretes LSA-E </h5>
                                <p className={`parrafoNamesEquipo  ${incSize ? "fs-5" : "fs-6"}`}>Bárbara Di Pasquo</p>
                                <p className={`parrafoNamesEquipo  ${incSize ? "fs-5" : "fs-6"}`}>María Cecilia Fernández</p>

                                <h5 className={`titleEquipo fw-bold ${incSize ? "fs-4" : "fs-5"}`}>Área Escuelas de Sordos </h5>
                                <p className={`parrafoNamesEquipo  ${incSize ? "fs-5" : "fs-6"}`}>Carina Palacio</p>
                                <p className={`parrafoNamesEquipo  ${incSize ? "fs-5" : "fs-6"}`}>Sabrina López Ortiz </p>
                                ...
                                <h5 className={`titleEquipo fw-bold ${incSize ? "fs-4" : "fs-5"}`}>Área Traducción Audiovisual </h5>
                                <p className={`parrafoNamesEquipo  ${incSize ? "fs-5" : "fs-6"}`}>Caive Carone Fernández </p>
                            ...
                            <div className="col-lg-4 col-xs-12">
                                ...
                                <h5 className={`titleEquipo2 fw-bold ${incSize ? "fs-4" : "fs-5"}`}>Responsable Tecnópolis </h5>
                                <p className={`parrafoNamesEquipo2 ${incSize ? "fs-5" : "fs-6"}`}>Alexis Fasolari</p>

                                <h5 className={`titleEquipo2 fw-bold ${incSize ? "fs-4" : "fs-5"}`}>Responsable Casa <br></br>del Bicentenario </h5>
                                <p className={`parrafoNamesEquipo2 ${incSize ? "fs-5" : "fs-6"}`}>Row Propato</p>

                                <h5 className={`titleEquipo2 fw-bold ${incSize ? "fs-4" : "fs-5"}`}>Responsable Institucionales<br></br> y General </h5>
                            ...
                            <div className="col-lg-4 col-xs-12">
                                ...
                                <h5 className={`titleEquipo2 fw-bold ${incSize ? "fs-4" : "fs-5"}`}>Área Diseño y Desarrollo Web </h5>
                        ...
                        <article className="mailsGrid row">
                            <div className="col-lg-6 col-xs-12">
                                ...
                                <p className="parrafoMails mt-3"> <span className="fw-bold">Información General:</span> info@ficsor.com.ar </p>
                                <p className="parrafoMails"> <span className="fw-bold">Producción General:</span> produccion@ficsor.com.ar </p>
                                <p className="parrafoMails"> <span className="fw-bold">Dirección General:</span> direccion@ficsor.com.ar </p>
                            ...
                            <div className="col-lg-6 col-xs-12 ">
                                ...
                                <p className="parrafoMails mt-5"> <span className="fw-bold">Diseño:</span> diseño@ficsor.com.ar </p>
                            </div>
                        </article>
                    </div>
                </article>
